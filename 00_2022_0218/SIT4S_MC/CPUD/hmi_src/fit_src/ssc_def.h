...
#define		E_CPUC_VER4	'o'							//CPU-C VER. No.
...
//		: 2016/05/10	周辺機連動機能追加仕様（指摘箇所修正）
//V01g	: 2016/06/16	サム異常網掛けソフト組込み
//V01h	: 2016/07/09	補正モニタ表示中の出力ビット不具合修正（V01f：周辺機連動機能追加から発生！）
//V01i	: 2017/11/06	パスワード機能追加
//V01j  : 2018/10/29    高速ルーレット復活
//v01k  : 2019/06/07    待機点切替えの振子、反転待機点
//V01l  : 2020/01/30    koma 外部タイマの上限切替
//V01m  : 2020/05/07    koma 待機点切替-進角設定できない不具合　ssc_disp.c
//V01n  : 2020/11/20    koma sum-err
//V01o  : 2021/06/24    koma adc
