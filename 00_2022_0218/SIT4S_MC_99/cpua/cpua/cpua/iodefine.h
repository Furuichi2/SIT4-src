...
/************************************************************************/
/*      SH7750 Series Include File              Ver 1.2a HEW2.0_2001.12 */
/************************************************************************/
...
struct st_intc {                                        /* struct INTC  */
               ...
               union {                                  /* IPRA         */
                     unsigned short WORD;               /*  Word Access */
                     struct {                           /*  Bit  Access */
                            unsigned short TMU0:4;      /*    TMU0      */
                            unsigned short TMU1:4;      /*    TMU1      */
                            unsigned short TMU2:4;      /*    TMU2      */
                            unsigned short RTC :4;      /*    RTC       */
                            }       BIT;                /*              */
                     }          IPRA;                   /*              */
               char             wk2 [2];                /*              */
               union {                                  /* IPRB         */
                     ...
                     struct {                           /*  Bit  Access */
                            ...
                            unsigned short REF:4;       /*    REF       */
                            unsigned short SCIPR:4;     /*    SCI       */
                            unsigned short    :4;       /*              */
                            }       BIT;                /*              */
                     }          IPRB;                   /*              */
               char             wk3 [2];                /*              */
               union {                                  /* IPRC         */
                     unsigned short WORD;               /*  Word Access */
                     struct {                           /*  Bit  Access */
                            unsigned short GPIO:4;      /*    GPIO      */
                            unsigned short DMAC:4;      /*    DMAC      */
                            unsigned short SCIF:4;      /*    SCIF      */
                            unsigned short HUDI:4;      /*    HUDI      */
                            }       BIT;                /*              */
                     }          IPRC;                   /*              */
};                                                      /*              */
...
struct st_bsc {                                         /* struct BSC   */
             union {                                    /*  BCR1        */
                   ...
                   struct {                             /*  Bit  Access */
                          ...
                          unsigned int   A0BST :3;      /*              */
                          unsigned int   A5BST :3;      /*              */
                          unsigned int   A6BST :3;      /*              */
                          unsigned int   DRAMTP:3;      /*              */
                          unsigned int         :1;      /*              */
             ...
             union {                                    /*  PCR         */
                   unsigned short    WORD;              /*  Word Access */
                   struct {                             /*  Bit  Access */
                          unsigned short A5PCW :2;      /*              */
                          unsigned short A6PCW :2;      /*              */
                          unsigned short A5TED :3;      /*              */
                          unsigned short A6TED :3;      /*              */
                          unsigned short A5TEH :3;      /*              */
                          unsigned short A6TEH :3;      /*              */
                          }          BIT;               /*              */
                   }            PCR;                    /*              */
               char             wk2 [2];                /*              */
             union {                                    /*  RTCSR       */
...
struct st_cpg {                                         /* struct CPG   */
             union {                                    /*  FRQCR       */
                   ...
                   struct {                             /*  Bit  Access */
                          ...
                          unsigned short PLL1EN:1;      /*              */
                          unsigned short PLL2EN:1;      /*              */
                          unsigned short IFC   :3;      /*              */
                          unsigned short BFC   :3;      /*              */
                          unsigned short PFC   :3;      /*              */
                          }          BIT;               /*              */
                   }           FRQCR;                   /*              */
               char             wk1 [2];                /*              */
             union {                                    /*  STBCR       */
             ...
             char              wk2[3];                  /*              */
             union {                                    /* WTCNT        */
                   unsigned short WTCNT_W;              /*  Word Access */
                   struct {                             /*  Byte Access */
                          unsigned char WORK;           /*  High        */
                          unsigned char WTCNT_R;        /*  Low         */
                          }       BYTE;                 /*              */
                   }           WTCNT;                   /*              */
             char              wk3[2];                  /*              */
             union {                                    /* WTCSR        */
                   unsigned short WTCSR_W;              /*  Word Access */
                   struct {                             /*  Byte Access */
                          unsigned char WORK;           /*  High        */
                          union  {                      /*  WTCSR_R     */
                             unsigned char WTCSR_R;     /*  Byte Access */
                             struct {                   /*  Bit  Access */
                                    unsigned char TMI :1; /*            */
                                    unsigned char WT  :1; /*            */
...
struct st_mmu {                                         /* struct MMU   */
             ...
             union {                                    /*  MMUCR       */
                   unsigned int       LONG;             /*  Long Access */
                   struct {                             /*  Bit  Access */
                          unsigned int LRUI:6;          /*    LRUI      */
                          unsigned int     :2;          /*              */
                          unsigned int URB :6;          /*    URB       */
                          unsigned int     :2;          /*              */
                          unsigned int URC :6;          /*    URC       */
                          unsigned int SQMD:1;          /*    SQMD      */
                          unsigned int SV  :1;          /*    SV        */
                          unsigned int     :5;          /*              */
                          unsigned int TI  :1;          /*    TI        */
                          unsigned int     :1;          /*              */
                          unsigned int AT  :1;          /*    AT        */
                          }          BIT;               /*              */
                   }           MMUCR ;                  /* MMUCR        */
              char             wk[32];                  /*              */
...
struct st_port {                                        /* struct PORT  */
             union {                                    /*  PORT        */
                   unsigned int      LONG;              /*  Long Access */
                   struct {                             /*  Bit  Access */
                          unsigned int   PB15PUP:1;     /*              */
                          unsigned int   PB15IO :1;     /*              */
                          unsigned int   PB14PUP:1;     /*              */
                          unsigned int   PB14IO :1;     /*              */
                          unsigned int   PB13PUP:1;     /*              */
                          unsigned int   PB13IO :1;     /*              */
                          unsigned int   PB12PUP:1;     /*              */
                          unsigned int   PB12IO :1;     /*              */
                          unsigned int   PB11PUP:1;     /*              */
                          unsigned int   PB11IO :1;     /*              */
                          unsigned int   PB10PUP:1;     /*              */
                          unsigned int   PB10IO :1;     /*              */
                          unsigned int   PB9PUP:1;      /*              */
                          unsigned int   PB9IO :1;      /*              */
                          unsigned int   PB8PUP:1;      /*              */
                          unsigned int   PB8IO :1;      /*              */
                          unsigned int   PB7PUP:1;      /*              */
                          unsigned int   PB7IO :1;      /*              */
                          unsigned int   PB6PUP:1;      /*              */
                          unsigned int   PB6IO :1;      /*              */
                          unsigned int   PB5PUP:1;      /*              */
                          unsigned int   PB5IO :1;      /*              */
                          unsigned int   PB4PUP:1;      /*              */
                          unsigned int   PB4IO :1;      /*              */
                          unsigned int   PB3PUP:1;      /*              */
                          unsigned int   PB3IO :1;      /*              */
                          unsigned int   PB2PUP:1;      /*              */
                          unsigned int   PB2IO :1;      /*              */
                          unsigned int   PB1PUP:1;      /*              */
                          unsigned int   PB1IO :1;      /*              */
                          unsigned int   PB0PUP:1;      /*              */
                          unsigned int   PB0IO :1;      /*              */
                          }          BIT;               /*              */
                   }         PCTRA;                     /*              */
             union {                                    /*              */
                   unsigned short   WORD;               /*  Word Access */
                   struct {                             /*  Bit  Access */
                          unsigned short P15DT  :1;     /*              */
                          unsigned short P14DT  :1;     /*              */
                          unsigned short P13DT  :1;     /*              */
                          unsigned short P12DT  :1;     /*              */
                          unsigned short P11DT  :1;     /*              */
                          unsigned short P10DT  :1;     /*              */
                          unsigned short P9DT   :1;     /*              */
                          unsigned short P8DT   :1;     /*              */
                          unsigned short P7DT   :1;     /*              */
                          unsigned short P6DT   :1;     /*              */
                          unsigned short P5DT   :1;     /*              */
                          unsigned short P4DT   :1;     /*              */
                          unsigned short P3DT   :1;     /*              */
                          unsigned short P2DT   :1;     /*              */
                          unsigned short P1DT   :1;     /*              */
                          unsigned short P0DT   :1;     /*              */
                          }          BIT;               /*              */
                   }         PDTRA;                     /*              */
              char             wk1[14];                 /*              */
             union {                                    /*  PORT        */
                   ...
                   struct {                             /*  Bit  Access */
                          unsigned int         :24;     /*              */
                          unsigned int   PB19PUP:1;     /*              */
                          unsigned int   PB19IO :1;     /*              */
                          unsigned int   PB18PUP:1;     /*              */
                          unsigned int   PB18IO :1;     /*              */
                          unsigned int   PB17PUP:1;     /*              */
                          unsigned int   PB17IO :1;     /*              */
                          unsigned int   PB16PUP:1;     /*              */
                          unsigned int   PB16IO :1;     /*              */
                          }          BIT;               /*              */
                   }         PCTRB;                     /*              */
             union {                                    /*              */
                   unsigned short   WORD;               /*  Word Access */
                   struct {                             /*  Bit  Access */
                          unsigned short       :12;     /*              */
                          unsigned short P19DT  :1;     /*              */
                          unsigned short P18DT  :1;     /*              */
                          unsigned short P17DT  :1;     /*              */
                          unsigned short P16DT  :1;     /*              */
                          }          BIT;               /*              */
                   }         PDTRB;                     /*              */
              char             wk2[2];                  /*              */
             union {                                    /*  PORT        */
                   unsigned short   WORD;               /*  Long Access */
                   struct {                             /*  Bit  Access */
                          unsigned int  PTIREN15:1;     /*              */
                          unsigned int  PTIREN14:1;     /*              */
                          unsigned int  PTIREN13:1;     /*              */
                          unsigned int  PTIREN12:1;     /*              */
                          unsigned int  PTIREN11:1;     /*              */
                          unsigned int  PTIREN10:1;     /*              */
                          unsigned int  PTIREN9 :1;     /*              */
                          unsigned int  PTIREN8 :1;     /*              */
                          unsigned int  PTIREN7 :1;     /*              */
                          unsigned int  PTIREN6 :1;     /*              */
                          unsigned int  PTIREN5 :1;     /*              */
                          unsigned int  PTIREN4 :1;     /*              */
                          unsigned int  PTIREN3 :1;     /*              */
                          unsigned int  PTIREN2 :1;     /*              */
                          unsigned int  PTIREN1 :1;     /*              */
                          unsigned int  PTIREN0 :1;     /*              */
                          }          BIT;               /*              */
                   }        GPIOIC;                     /*              */
};                                                      /*              */

#define P_SCI (*(volatile struct st_sci   *)0xFFE00000) /* SCI   Address*/
#define P_SCIF (*(volatile struct st_scif  *)0xFFE80000) /* SCIF  Address*/
#define P_TMU (*(volatile struct st_tmu   *)0xFFD80000) /* TMU   Address*/
#define P_TMU0 (*(volatile struct st_tmu0  *)0xFFD80008) /* TMU0  Address*/
#define P_TMU1 (*(volatile struct st_tmu0  *)0xFFD80014) /* TMU1  Address*/
#define P_TMU2 (*(volatile struct st_tmu2  *)0xFFD80020) /* TMU2  Address*/
#define P_RTC (*(volatile struct st_rtc   *)0xFFC80000) /* RTC   Address*/
#define P_INTC (*(volatile struct st_intc  *)0xFFD00000) /* INTC  Address*/
#define P_BSC (*(volatile struct st_bsc   *)0xFF800000) /* BSC   Address*/
#define P_CPG (*(volatile struct st_cpg   *)0xFFC00000) /* CPG   Address*/
#define P_MMU (*(volatile struct st_mmu   *)0xFF000000) /* MMU   Address*/
#define P_CACHE (*(volatile struct st_cache *)0xFF00001C) /* CACHE Address*/
#define P_DMAC (*(volatile struct st_dmac  *)0xFFA00040) /* DMAC  Address*/
#define P_DMAC0 (*(volatile struct st_dmac0 *)0xFFA00000) /* DMAC0 Address*/
#define P_DMAC1 (*(volatile struct st_dmac0 *)0xFFA00010) /* DMAC1 Address*/
#define P_DMAC2 (*(volatile struct st_dmac0 *)0xFFA00020) /* DMAC2 Address*/
#define P_DMAC3 (*(volatile struct st_dmac0 *)0xFFA00030) /* DMAC3 Address*/
#define P_PORT (*(volatile struct st_port  *)0xFF80002C) /* PORT  Address*/
#define P_EXP (*(volatile struct st_exp   *)0xFF000020) /* TRA   Address*/
