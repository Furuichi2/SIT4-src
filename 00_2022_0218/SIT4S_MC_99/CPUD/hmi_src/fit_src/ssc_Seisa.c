...
extern	UNs		GMN_PAR048;						//荷重制御有効／無効							2015/09/29
extern	UNs		CB_SYS_PARAM375;				//ﾓｰｼｮﾝ加減速選択								2016/04/16
...
#if (mot100_test == 1)
void	mmon_step_chg_disp(void);				//行程数変更のﾁｪｯｸ&表示
UNs		step_pos_prs_chk(UNs step);				//指定行程の目標確認（位置or荷重）
void	mmon_agl_ovbit_make(void);				//目標角がオーバーしている行のビット情報を作成
void	mmon_spd_ovbit_make(void);				//速度がオーバーしている行のビット情報を作成
void	mmon_spd_lmbit_make(void);				//速度が低すぎる行のビット情報を作成
void	mmon_act_step_bit_make(void);			//モーション実行行程のビット情報を作成
void	MOT_CHG_REQ(UNs t_no);					//モーション変更行程の送信要求
void	mmon_deg_chg_uphold100(UNs step, UNs *deg, UNl *pos);
void	step_chg_spd_make(void);				//変速情報作成（前or後）
#endif
...
const	MOT_PAGE_DAT_TDEF	MOT_PAGE_DAT[20] = {
	{
		/* 1ページ目  1～5段モーションデータ */
		&SV_1DANDEG_SRV, &SV_2DANDEG_SRV, &SV_3DANDEG_SRV, &SV_4DANDEG_SRV, &SV_5DANDEG_SRV,		//角度
		&SV_1DANPOS_SRV, &SV_2DANPOS_SRV, &SV_3DANPOS_SRV, &SV_4DANPOS_SRV, &SV_5DANPOS_SRV,		//位置
		&SV_1DANPRS_SRV, &SV_2DANPRS_SRV, &SV_3DANPRS_SRV, &SV_4DANPRS_SRV, &SV_5DANPRS_SRV,		//荷重
		&SV_1DANSPD_SRV, &SV_2DANSPD_SRV, &SV_3DANSPD_SRV, &SV_4DANSPD_SRV, &SV_5DANSPD_SRV,		//速度
		&SV_1DANTIM_SRV, &SV_2DANTIM_SRV, &SV_3DANTIM_SRV, &SV_4DANTIM_SRV, &SV_5DANTIM_SRV			//停止時間
	},
	{
		/* 2ページ目  1～5段モーションデータ */
		&SV_6DANDEG_SRV, &SV_7DANDEG_SRV, &SV_8DANDEG_SRV, &SV_9DANDEG_SRV, &SV_10DANDEG_SRV,		//角度
		&SV_6DANPOS_SRV, &SV_7DANPOS_SRV, &SV_8DANPOS_SRV, &SV_9DANPOS_SRV, &SV_10DANPOS_SRV,		//位置
		&SV_6DANPRS_SRV, &SV_7DANPRS_SRV, &SV_8DANPRS_SRV, &SV_9DANPRS_SRV, &SV_10DANPRS_SRV,		//荷重
		&SV_6DANSPD_SRV, &SV_7DANSPD_SRV, &SV_8DANSPD_SRV, &SV_9DANSPD_SRV, &SV_10DANSPD_SRV,		//速度
		&SV_6DANTIM_SRV, &SV_7DANTIM_SRV, &SV_8DANTIM_SRV, &SV_9DANTIM_SRV, &SV_10DANTIM_SRV			//停止時間
	},
	{
		/* 3ページ目  1～5段モーションデータ */
		&SV_11DANDEG_SRV, &SV_12DANDEG_SRV, &SV_13DANDEG_SRV, &SV_14DANDEG_SRV, &SV_15DANDEG_SRV,		//角度
		&SV_11DANPOS_SRV, &SV_12DANPOS_SRV, &SV_13DANPOS_SRV, &SV_14DANPOS_SRV, &SV_15DANPOS_SRV,		//位置
		&SV_11DANPRS_SRV, &SV_12DANPRS_SRV, &SV_13DANPRS_SRV, &SV_14DANPRS_SRV, &SV_15DANPRS_SRV,		//荷重
		&SV_11DANSPD_SRV, &SV_12DANSPD_SRV, &SV_13DANSPD_SRV, &SV_14DANSPD_SRV, &SV_15DANSPD_SRV,		//速度
		&SV_11DANTIM_SRV, &SV_12DANTIM_SRV, &SV_13DANTIM_SRV, &SV_14DANTIM_SRV, &SV_15DANTIM_SRV			//停止時間
	},
	{
		/* 4ページ目  1～5段モーションデータ */
		&SV_16DANDEG_SRV, &SV_17DANDEG_SRV, &SV_18DANDEG_SRV, &SV_19DANDEG_SRV, &SV_20DANDEG_SRV,		//角度
		&SV_16DANPOS_SRV, &SV_17DANPOS_SRV, &SV_18DANPOS_SRV, &SV_19DANPOS_SRV, &SV_20DANPOS_SRV,		//位置
		&SV_16DANPRS_SRV, &SV_17DANPRS_SRV, &SV_18DANPRS_SRV, &SV_19DANPRS_SRV, &SV_20DANPRS_SRV,		//荷重
		&SV_16DANSPD_SRV, &SV_17DANSPD_SRV, &SV_18DANSPD_SRV, &SV_19DANSPD_SRV, &SV_20DANSPD_SRV,		//速度
		&SV_16DANTIM_SRV, &SV_17DANTIM_SRV, &SV_18DANTIM_SRV, &SV_19DANTIM_SRV, &SV_20DANTIM_SRV			//停止時間
	},
	{
		/* 5ページ目  1～5段モーションデータ */
		&SV_21DANDEG_SRV, &SV_22DANDEG_SRV, &SV_23DANDEG_SRV, &SV_24DANDEG_SRV, &SV_25DANDEG_SRV,		//角度
		&SV_21DANPOS_SRV, &SV_22DANPOS_SRV, &SV_23DANPOS_SRV, &SV_24DANPOS_SRV, &SV_25DANPOS_SRV,		//位置
		&SV_21DANPRS_SRV, &SV_22DANPRS_SRV, &SV_23DANPRS_SRV, &SV_24DANPRS_SRV, &SV_25DANPRS_SRV,		//荷重
		&SV_21DANSPD_SRV, &SV_22DANSPD_SRV, &SV_23DANSPD_SRV, &SV_24DANSPD_SRV, &SV_25DANSPD_SRV,		//速度
		&SV_21DANTIM_SRV, &SV_22DANTIM_SRV, &SV_23DANTIM_SRV, &SV_24DANTIM_SRV, &SV_25DANTIM_SRV			//停止時間
	},
	{
		/* 6ページ目  1～5段モーションデータ */
		&SV_26DANDEG_SRV, &SV_27DANDEG_SRV, &SV_28DANDEG_SRV, &SV_29DANDEG_SRV, &SV_30DANDEG_SRV,		//角度
		&SV_26DANPOS_SRV, &SV_27DANPOS_SRV, &SV_28DANPOS_SRV, &SV_29DANPOS_SRV, &SV_30DANPOS_SRV,		//位置
		&SV_26DANPRS_SRV, &SV_27DANPRS_SRV, &SV_28DANPRS_SRV, &SV_29DANPRS_SRV, &SV_30DANPRS_SRV,		//荷重
		&SV_26DANSPD_SRV, &SV_27DANSPD_SRV, &SV_28DANSPD_SRV, &SV_29DANSPD_SRV, &SV_30DANSPD_SRV,		//速度
		&SV_26DANTIM_SRV, &SV_27DANTIM_SRV, &SV_28DANTIM_SRV, &SV_29DANTIM_SRV, &SV_30DANTIM_SRV			//停止時間
	},
	{
		/* 7ページ目  1～5段モーションデータ */
		&SV_31DANDEG_SRV, &SV_32DANDEG_SRV, &SV_33DANDEG_SRV, &SV_34DANDEG_SRV, &SV_35DANDEG_SRV,		//角度
		&SV_31DANPOS_SRV, &SV_32DANPOS_SRV, &SV_33DANPOS_SRV, &SV_34DANPOS_SRV, &SV_35DANPOS_SRV,		//位置
		&SV_31DANPRS_SRV, &SV_32DANPRS_SRV, &SV_33DANPRS_SRV, &SV_34DANPRS_SRV, &SV_35DANPRS_SRV,		//荷重
		&SV_31DANSPD_SRV, &SV_32DANSPD_SRV, &SV_33DANSPD_SRV, &SV_34DANSPD_SRV, &SV_35DANSPD_SRV,		//速度
		&SV_31DANTIM_SRV, &SV_32DANTIM_SRV, &SV_33DANTIM_SRV, &SV_34DANTIM_SRV, &SV_35DANTIM_SRV			//停止時間
	},
	{
		/* 8ページ目  1～5段モーションデータ */
		&SV_36DANDEG_SRV, &SV_37DANDEG_SRV, &SV_38DANDEG_SRV, &SV_39DANDEG_SRV, &SV_40DANDEG_SRV,		//角度
		&SV_36DANPOS_SRV, &SV_37DANPOS_SRV, &SV_38DANPOS_SRV, &SV_39DANPOS_SRV, &SV_40DANPOS_SRV,		//位置
		&SV_36DANPRS_SRV, &SV_37DANPRS_SRV, &SV_38DANPRS_SRV, &SV_39DANPRS_SRV, &SV_40DANPRS_SRV,		//荷重
		&SV_36DANSPD_SRV, &SV_37DANSPD_SRV, &SV_38DANSPD_SRV, &SV_39DANSPD_SRV, &SV_40DANSPD_SRV,		//速度
		&SV_36DANTIM_SRV, &SV_37DANTIM_SRV, &SV_38DANTIM_SRV, &SV_39DANTIM_SRV, &SV_40DANTIM_SRV			//停止時間
	},
	{
		/* 9ページ目  1～5段モーションデータ */
		&SV_41DANDEG_SRV, &SV_42DANDEG_SRV, &SV_43DANDEG_SRV, &SV_44DANDEG_SRV, &SV_45DANDEG_SRV,		//角度
		&SV_41DANPOS_SRV, &SV_42DANPOS_SRV, &SV_43DANPOS_SRV, &SV_44DANPOS_SRV, &SV_45DANPOS_SRV,		//位置
		&SV_41DANPRS_SRV, &SV_42DANPRS_SRV, &SV_43DANPRS_SRV, &SV_44DANPRS_SRV, &SV_45DANPRS_SRV,		//荷重
		&SV_41DANSPD_SRV, &SV_42DANSPD_SRV, &SV_43DANSPD_SRV, &SV_44DANSPD_SRV, &SV_45DANSPD_SRV,		//速度
		&SV_41DANTIM_SRV, &SV_42DANTIM_SRV, &SV_43DANTIM_SRV, &SV_44DANTIM_SRV, &SV_45DANTIM_SRV			//停止時間
	},
	{
		/* 10ページ目  1～5段モーションデータ */
		&SV_46DANDEG_SRV, &SV_47DANDEG_SRV, &SV_48DANDEG_SRV, &SV_49DANDEG_SRV, &SV_50DANDEG_SRV,		//角度
		&SV_46DANPOS_SRV, &SV_47DANPOS_SRV, &SV_48DANPOS_SRV, &SV_49DANPOS_SRV, &SV_50DANPOS_SRV,		//位置
		&SV_46DANPRS_SRV, &SV_47DANPRS_SRV, &SV_48DANPRS_SRV, &SV_49DANPRS_SRV, &SV_50DANPRS_SRV,		//荷重
		&SV_46DANSPD_SRV, &SV_47DANSPD_SRV, &SV_48DANSPD_SRV, &SV_49DANSPD_SRV, &SV_50DANSPD_SRV,		//速度
		&SV_46DANTIM_SRV, &SV_47DANTIM_SRV, &SV_48DANTIM_SRV, &SV_49DANTIM_SRV, &SV_50DANTIM_SRV			//停止時間
	},
	{
		/* 11ページ目  1～5段モーションデータ */
		&SV_51DANDEG_SRV, &SV_52DANDEG_SRV, &SV_53DANDEG_SRV, &SV_54DANDEG_SRV, &SV_55DANDEG_SRV,		//角度
		&SV_51DANPOS_SRV, &SV_52DANPOS_SRV, &SV_53DANPOS_SRV, &SV_54DANPOS_SRV, &SV_55DANPOS_SRV,		//位置
		&SV_51DANPRS_SRV, &SV_52DANPRS_SRV, &SV_53DANPRS_SRV, &SV_54DANPRS_SRV, &SV_55DANPRS_SRV,		//荷重
		&SV_51DANSPD_SRV, &SV_52DANSPD_SRV, &SV_53DANSPD_SRV, &SV_54DANSPD_SRV, &SV_55DANSPD_SRV,		//速度
		&SV_51DANTIM_SRV, &SV_52DANTIM_SRV, &SV_53DANTIM_SRV, &SV_54DANTIM_SRV, &SV_55DANTIM_SRV			//停止時間
	},
	{
		/* 12ページ目  1～5段モーションデータ */
		&SV_56DANDEG_SRV, &SV_57DANDEG_SRV, &SV_58DANDEG_SRV, &SV_59DANDEG_SRV, &SV_60DANDEG_SRV,		//角度
		&SV_56DANPOS_SRV, &SV_57DANPOS_SRV, &SV_58DANPOS_SRV, &SV_59DANPOS_SRV, &SV_60DANPOS_SRV,		//位置
		&SV_56DANPRS_SRV, &SV_57DANPRS_SRV, &SV_58DANPRS_SRV, &SV_59DANPRS_SRV, &SV_60DANPRS_SRV,		//荷重
		&SV_56DANSPD_SRV, &SV_57DANSPD_SRV, &SV_58DANSPD_SRV, &SV_59DANSPD_SRV, &SV_60DANSPD_SRV,		//速度
		&SV_56DANTIM_SRV, &SV_57DANTIM_SRV, &SV_58DANTIM_SRV, &SV_59DANTIM_SRV, &SV_60DANTIM_SRV			//停止時間
	},
	{
		/* 13ページ目  1～5段モーションデータ */
		&SV_61DANDEG_SRV, &SV_62DANDEG_SRV, &SV_63DANDEG_SRV, &SV_64DANDEG_SRV, &SV_65DANDEG_SRV,		//角度
		&SV_61DANPOS_SRV, &SV_62DANPOS_SRV, &SV_63DANPOS_SRV, &SV_64DANPOS_SRV, &SV_65DANPOS_SRV,		//位置
		&SV_61DANPRS_SRV, &SV_62DANPRS_SRV, &SV_63DANPRS_SRV, &SV_64DANPRS_SRV, &SV_65DANPRS_SRV,		//荷重
		&SV_61DANSPD_SRV, &SV_62DANSPD_SRV, &SV_63DANSPD_SRV, &SV_64DANSPD_SRV, &SV_65DANSPD_SRV,		//速度
		&SV_61DANTIM_SRV, &SV_62DANTIM_SRV, &SV_63DANTIM_SRV, &SV_64DANTIM_SRV, &SV_65DANTIM_SRV			//停止時間
	},
	{
		/* 14ページ目  1～5段モーションデータ */
		&SV_66DANDEG_SRV, &SV_67DANDEG_SRV, &SV_68DANDEG_SRV, &SV_69DANDEG_SRV, &SV_70DANDEG_SRV,		//角度
		&SV_66DANPOS_SRV, &SV_67DANPOS_SRV, &SV_68DANPOS_SRV, &SV_69DANPOS_SRV, &SV_70DANPOS_SRV,		//位置
		&SV_66DANPRS_SRV, &SV_67DANPRS_SRV, &SV_68DANPRS_SRV, &SV_69DANPRS_SRV, &SV_70DANPRS_SRV,		//荷重
		&SV_66DANSPD_SRV, &SV_67DANSPD_SRV, &SV_68DANSPD_SRV, &SV_69DANSPD_SRV, &SV_70DANSPD_SRV,		//速度
		&SV_66DANTIM_SRV, &SV_67DANTIM_SRV, &SV_68DANTIM_SRV, &SV_69DANTIM_SRV, &SV_70DANTIM_SRV			//停止時間
	},
	{
		/* 15ページ目  1～5段モーションデータ */
		&SV_71DANDEG_SRV, &SV_72DANDEG_SRV, &SV_73DANDEG_SRV, &SV_74DANDEG_SRV, &SV_75DANDEG_SRV,		//角度
		&SV_71DANPOS_SRV, &SV_72DANPOS_SRV, &SV_73DANPOS_SRV, &SV_74DANPOS_SRV, &SV_75DANPOS_SRV,		//位置
		&SV_71DANPRS_SRV, &SV_72DANPRS_SRV, &SV_73DANPRS_SRV, &SV_74DANPRS_SRV, &SV_75DANPRS_SRV,		//荷重
		&SV_71DANSPD_SRV, &SV_72DANSPD_SRV, &SV_73DANSPD_SRV, &SV_74DANSPD_SRV, &SV_75DANSPD_SRV,		//速度
		&SV_71DANTIM_SRV, &SV_72DANTIM_SRV, &SV_73DANTIM_SRV, &SV_74DANTIM_SRV, &SV_75DANTIM_SRV			//停止時間
	},
	{
		/* 16ページ目  1～5段モーションデータ */
		&SV_76DANDEG_SRV, &SV_77DANDEG_SRV, &SV_78DANDEG_SRV, &SV_79DANDEG_SRV, &SV_80DANDEG_SRV,		//角度
		&SV_76DANPOS_SRV, &SV_77DANPOS_SRV, &SV_78DANPOS_SRV, &SV_79DANPOS_SRV, &SV_80DANPOS_SRV,		//位置
		&SV_76DANPRS_SRV, &SV_77DANPRS_SRV, &SV_78DANPRS_SRV, &SV_79DANPRS_SRV, &SV_80DANPRS_SRV,		//荷重
		&SV_76DANSPD_SRV, &SV_77DANSPD_SRV, &SV_78DANSPD_SRV, &SV_79DANSPD_SRV, &SV_80DANSPD_SRV,		//速度
		&SV_76DANTIM_SRV, &SV_77DANTIM_SRV, &SV_78DANTIM_SRV, &SV_79DANTIM_SRV, &SV_80DANTIM_SRV			//停止時間
	},
	{
		/* 17ページ目  1～5段モーションデータ */
		&SV_81DANDEG_SRV, &SV_82DANDEG_SRV, &SV_83DANDEG_SRV, &SV_84DANDEG_SRV, &SV_85DANDEG_SRV,		//角度
		&SV_81DANPOS_SRV, &SV_82DANPOS_SRV, &SV_83DANPOS_SRV, &SV_84DANPOS_SRV, &SV_85DANPOS_SRV,		//位置
		&SV_81DANPRS_SRV, &SV_82DANPRS_SRV, &SV_83DANPRS_SRV, &SV_84DANPRS_SRV, &SV_85DANPRS_SRV,		//荷重
		&SV_81DANSPD_SRV, &SV_82DANSPD_SRV, &SV_83DANSPD_SRV, &SV_84DANSPD_SRV, &SV_85DANSPD_SRV,		//速度
		&SV_81DANTIM_SRV, &SV_82DANTIM_SRV, &SV_83DANTIM_SRV, &SV_84DANTIM_SRV, &SV_85DANTIM_SRV			//停止時間
	},
	{
		/* 18ページ目  1～5段モーションデータ */
		&SV_86DANDEG_SRV, &SV_87DANDEG_SRV, &SV_88DANDEG_SRV, &SV_89DANDEG_SRV, &SV_90DANDEG_SRV,		//角度
		&SV_86DANPOS_SRV, &SV_87DANPOS_SRV, &SV_88DANPOS_SRV, &SV_89DANPOS_SRV, &SV_90DANPOS_SRV,		//位置
		&SV_86DANPRS_SRV, &SV_87DANPRS_SRV, &SV_88DANPRS_SRV, &SV_89DANPRS_SRV, &SV_90DANPRS_SRV,		//荷重
		&SV_86DANSPD_SRV, &SV_87DANSPD_SRV, &SV_88DANSPD_SRV, &SV_89DANSPD_SRV, &SV_90DANSPD_SRV,		//速度
		&SV_86DANTIM_SRV, &SV_87DANTIM_SRV, &SV_88DANTIM_SRV, &SV_89DANTIM_SRV, &SV_90DANTIM_SRV			//停止時間
	},
	{
		/* 19ページ目  1～5段モーションデータ */
		&SV_91DANDEG_SRV, &SV_92DANDEG_SRV, &SV_93DANDEG_SRV, &SV_94DANDEG_SRV, &SV_95DANDEG_SRV,		//角度
		&SV_91DANPOS_SRV, &SV_92DANPOS_SRV, &SV_93DANPOS_SRV, &SV_94DANPOS_SRV, &SV_95DANPOS_SRV,		//位置
		&SV_91DANPRS_SRV, &SV_92DANPRS_SRV, &SV_93DANPRS_SRV, &SV_94DANPRS_SRV, &SV_95DANPRS_SRV,		//荷重
		&SV_91DANSPD_SRV, &SV_92DANSPD_SRV, &SV_93DANSPD_SRV, &SV_94DANSPD_SRV, &SV_95DANSPD_SRV,		//速度
		&SV_91DANTIM_SRV, &SV_92DANTIM_SRV, &SV_93DANTIM_SRV, &SV_94DANTIM_SRV, &SV_95DANTIM_SRV			//停止時間
	},
	{
		/* 20ページ目  1～5段モーションデータ */
		&SV_96DANDEG_SRV, &SV_97DANDEG_SRV, &SV_98DANDEG_SRV, &SV_99DANDEG_SRV, &SV_100DANDEG_SRV,		//角度
		&SV_96DANPOS_SRV, &SV_97DANPOS_SRV, &SV_98DANPOS_SRV, &SV_99DANPOS_SRV, &SV_100DANPOS_SRV,		//位置
		&SV_96DANPRS_SRV, &SV_97DANPRS_SRV, &SV_98DANPRS_SRV, &SV_99DANPRS_SRV, &SV_100DANPRS_SRV,		//荷重
		&SV_96DANSPD_SRV, &SV_97DANSPD_SRV, &SV_98DANSPD_SRV, &SV_99DANSPD_SRV, &SV_100DANSPD_SRV,		//速度
		&SV_96DANTIM_SRV, &SV_97DANTIM_SRV, &SV_98DANTIM_SRV, &SV_99DANTIM_SRV, &SV_100DANTIM_SRV			//停止時間
	}
};
#endif
					...
					switch(KEY_DATA_CODE) {
						...
						case E_key_sw7:			//key code SW7		//2016/03/18
							if (SV0_LFEED_SEL & BIT_0) {
								disp_stg_sel = E_sstg_lfeed;			//生産[フィーダ設定]へ
								WINDOW_NO = 25;
								WIN_gamen_disp();						//ウインドウ画面表示
							}
							break;
						...
						case E_key_sw6:			//key code SW6
							...
							if ( ( SV_buff[SV_TBL_POS_NOW].SUB_NO == 53 ) &&		//行程設定箇所				2014/09/08
								...
								//2020-09-01[2] SEI_test_out_sw5,6 sum演算対象
...
#if (mot100_test == 1)
			mmon_agl_ovbit_make();				//目標角がオーバーしている行のビット情報を作成
			mmon_spd_ovbit_make();				//速度がオーバーしている行のビット情報を作成
			mmon_spd_lmbit_make();				//速度が低すぎる行のビット情報を作成
			mmon_act_step_bit_make();			//モーション実行行程のビット情報を作成
#endif
			switch(KEY_DATA_MODE) {
				case E_key_ent_mode:		//ENT key mode
					i = SV_TBL_POS_NOW;
...
#if (mot100_test == 1)
					mmon_step_chg_disp();						//行程数変更のﾁｪｯｸ&表示
					MOT_CHG_REQ(j);								//モーション変更行程の送信要求
#endif
					break;
...
//V01z								else if(CSR_buff[CSR_TBL_POS_NOW].DATA_NO >= 97 ) {	//ｶｰｿﾙ種別番号（設定値のｸﾞﾙｰﾌﾟ番号と同じ）
									...
									if (CSR_buff[CSR_TBL_POS_NOW].SW6_DN == 60) {		//SW6下段ｷｬﾗｸﾀ
										...
										mmon_trans_put();								//回転方式によるﾃﾞｰﾀの格納
#if (mot100_test == 1)
										MOT_CHG_REQ(CSR_TBL_POS_NOW);					//モーション変更行程の送信要求
#endif
									}
	...
	switch( i ) {
		...
		case 86:				//ﾓｰｼｮﾝ画面　目標角1
			...
			if(MOTION_SV_CHG_CANCEL == 0) {			/* V01d */
				*pos = DigRnaChange1(*deg);									//角度→mm変換

				if(SEQ_050_SV & BIT_1) {		//反転　？
					*pos = *pos - SV_NEG_OFS_LNG;
				}

				*pos = cnv_mm_inch(*pos, 0);								//単位切替(mm→mm/INCH)
			}
#else
			if(MOTION_SV_CHG_CANCEL == 0) {			/* V01d */
			...
			if ( i == 0 ) {						//目標は位置？
				long_bf = *pos;					//位置更新（位置は角度変更にてよって更新されたから）
...
//koma 2014-08-11			SV_TAIKIKAKU_SRV = RnaDigChange1(SV_TAIKIKAKU_SRV, long_bf);	//mm変換→角度
		...
		case 92:				//ﾓｰｼｮﾝ画面　目標位置1 or 目標荷重1
#if (mot100_test == 1)
			step = (SV_MOT_PAGE * 5) + 0;
			i = step_pos_prs_chk(step);
			if ( i == 0 ) {												//目標位置変更？
...
////				long_bf = cnv_inch_mm(SV_1DANPOS_SRV, 0);					//単位切替(mm/INCH→mm)
				pos = MOT_PAGE_DAT[SV_MOT_PAGE].POS1;
				long_bf = cnv_inch_mm(*pos, 0);									//単位切替(mm/INCH→mm)
...
////					SV_1DANDEG_SRV = RnaDigChange1(SV_1DANDEG_SRV, long_bf);	//mm変換→角度
					*deg = RnaDigChange1(*deg, long_bf);						//mm変換→角度
				}
...
//2015/11/15				mmon_deg_chg_uphold1(t_no-1, &SV_1DANDEG_SRV, &SV_1DANPOS_SRV, &SV_2DANDEG_SRV, &SV_2DANPOS_SRV, 9);	/* V01d */
		...
		case 93:				//ﾓｰｼｮﾝ画面　目標位置2 or 目標荷重2
#if (mot100_test == 1)
			step = (SV_MOT_PAGE * 5) + 1;
			i = step_pos_prs_chk(step);
			if ( i == 0 ) {												//目標位置変更？
...
//2015/11/15				mmon_deg_chg_uphold1(t_no-1, &SV_2DANDEG_SRV, &SV_2DANPOS_SRV, &SV_3DANDEG_SRV, &SV_3DANPOS_SRV, 8);	/* V01d */
		...
		case 94:				//ﾓｰｼｮﾝ画面　目標位置3 or 目標荷重3
#if (mot100_test == 1)
			step = (SV_MOT_PAGE * 5) + 2;
			i = step_pos_prs_chk(step);
			if ( i == 0 ) {												//目標位置変更？
...
//2015/11/15				mmon_deg_chg_uphold1(t_no-1, &SV_3DANDEG_SRV, &SV_3DANPOS_SRV, &SV_4DANDEG_SRV, &SV_4DANPOS_SRV, 7);	/* V01d */
		...
		case 95:				//ﾓｰｼｮﾝ画面　目標位置4 or 目標荷重4
#if (mot100_test == 1)
			step = (SV_MOT_PAGE * 5) + 3;
			i = step_pos_prs_chk(step);
			if ( i == 0 ) {												//目標位置変更？
...
//2015/11/15				mmon_deg_chg_uphold1(t_no-1, &SV_4DANDEG_SRV, &SV_4DANPOS_SRV, &SV_5DANDEG_SRV, &SV_5DANPOS_SRV, 6);	/* V01d */
		...
		case 96:				//ﾓｰｼｮﾝ画面　目標位置5 or 目標荷重5
#if (mot100_test == 1)
			step = (SV_MOT_PAGE * 5) + 4;
			i = step_pos_prs_chk(step);
			if ( i == 0 ) {												//目標位置変更？
...
//2014-04-16 koma	if( (SEQ_050_SV & BIT_0) && (SEQ_028_SV & BIT_12) )		//回転？ 連寸一行程？
...
********************************************************************************
*  Module Name:		mmon_deg_chg_uphold1
*  Function Name:	ﾓｰｼｮﾝ角度の上昇ﾎｰﾙﾄﾞ角度ﾁｪｯｸ＆表示
*  Input	:		
*  Return	: 		なし
*  Note		:
*
*  履 歴	: A.Shimamura		ON:2015/11/15
********************************************************************************
*/
void	mmon_deg_chg_uphold100(UNs step, UNs *deg, UNl *pos)
{
...
void	mmon_trans_get(void)
{
	...
	if( SEQ_050_SV & BIT_1 ) {								//反転　？
		...
		for (c=0; c<100; c++, dst_s++, src_s++) {
			*dst_s = *src_s;									/* 1～100段 目標角 */
		}
		dst_l = &SV_1DANPOS_SRV;								//WORK
		src_l = &SV_MOTPOS1_001;								//FRAM
		for (c=0; c<100; c++, dst_l++, src_l++) {
			*dst_l = *src_l;									/* 1～100段 目標位置 */
		}
		dst_s = &SV_1DANSPD_SRV;								//WORK
		src_s = &SV_MOTSPD1_001;								//FRAM
		for (c=0; c<100; c++, dst_s++, src_s++) {
			*dst_s = *src_s;									/* 1～100段 速度 */
		}
		dst_s = &SV_1DANTIM_SRV;								//WORK
		src_s = &SV_MOTTIM1_001;								//FRAM
		for (c=0; c<100; c++, dst_s++, src_s++) {
			*dst_s = *src_s;									/* 1～100段 停止時間 */
		}
		dst_s = &SV_1DANPRS_SRV;								//WORK
		src_s = &SV_MOTPRS1_001;								//FRAM
		for (c=0; c<100; c++, dst_s++, src_s++) {
			*dst_s = *src_s;									/* 1～100段 目標荷重 */
		}
		if (GMN_PAR048 != 1) {					//荷重制御有効？
			/* 荷重制御無効 */
			SV_MOTTGT_INF0 = 0;				//目標位置／荷重切替BIT情報
			SV_MOTTGT_INF1 = 0;				//目標位置／荷重切替BIT情報
			SV_MOTTGT_INF2 = 0;				//目標位置／荷重切替BIT情報
			SV_MOTTGT_INF3 = 0;				//目標位置／荷重切替BIT情報
			SV_MOTTGT_INF4 = 0;				//目標位置／荷重切替BIT情報
			SV_MOTTGT_INF5 = 0;				//目標位置／荷重切替BIT情報
			SV_MOTTGT_INF6 = 0;				//目標位置／荷重切替BIT情報
		}
		else {
			dst_s = &SV_MOTTGT_INF0;								//WORK
			src_s = &SV_MOTTGT1_INF0;								//FRAM
			for (c=0; c<7; c++, dst_s++, src_s++) {
				*dst_s = *src_s;									/* 目標位置／荷重切替BIT情報 */
			}
		}
...
//2015/01/14
		...
		SV0_MOT_UDSEL = 0;									//ﾓｰｼｮﾝ加減速選択機能無効	2016/04/19
	}
...
//2015/01/14
		...
		if (CB_SYS_PARAM375 == 2) {							//2016/04/19
			SV0_MOT_UDSEL = BIT_0;							//ﾓｰｼｮﾝ加減速選択機能有効
		}
		else {
			SV0_MOT_UDSEL = 0;								//ﾓｰｼｮﾝ加減速選択機能無効
		}
	}
...
//2015/01/14
	...
	FRAM_csum_set_Spec();						//2020-09-1(_Spec) ﾌﾗｼｭRAM領域の設定値のﾁｪｯｸｻﾑ･ｺｰﾄﾞを作成
	KAT_DATCHG_FLG = 0xff;									//型データ変更フラグ
}
...
////		bit <<= step % 16;
////		if (inf & bit) {							//オーバーBIT ON？
////			limit_agl = PVP_CKLMT_AGLTOP1[step];	//各工程角度
////			chg = 0xff;
////		}
		i = CSR_buff[t_no].DATA_NO - 97;
		bit<<=i;
		if (PV0_CKAGL_OVBIT & bit) {
			limit_agl = PVP_CKLMT_AGL;				//各工程角度
			chg = 0xff;
		}
#else
		i = CSR_buff[t_no].DATA_NO - 97;
...
////////////		t_no_tanni = 5+no;								//6～10段目の単位のﾊﾞｯﾌｧｱﾄﾞﾚｽ
	...
	for(cnt=PV_CNT, t_no=0 ; cnt > 0 ; cnt--, t_no++){
		if(PV_buff[t_no].GRP_NO == sarch) {				//ｸﾞﾙｰﾌﾟ番号 ｻｰﾁ
			if(PV_buff[t_no].AKI2 == 1) {				//目標位置単位 ｻｰﾁ
				if (*inf & bit) {
					/* 位置 -> 荷重*/
					PV_buff[t_no].DATA_ADR = (UNs *)&CAR_KAJ_AREA;		//単位
				}
				else {
					/* 荷重 -> 位置 */
					PV_buff[t_no].DATA_ADR = (UNs *)&CAR_LNG_AREA;		//単位
				}
				break;
			}
		}
...
/*
********************************************************************************
*  Function Name:	ﾓｰｼｮﾝ表示ﾍﾟｰｼﾞ(段数)にﾃﾞｰﾀを合わせる
*  Input	:		なし
*  Return	: 		なし
*  Note		:
*
*  履 歴	:Shima		ON:2015-08-21
********************************************************************************
*/
void	mot_page_dat_chg(void)
{
	...
	step_chg_spd_make();				//変速情報作成（前or後）		2016/04/15
}
#endif
...
/*
********************************************************************************
*  Function Name:	ﾓｰｼｮﾝ表示ﾍﾟｰｼﾞの目標位置を目標荷重に変更
*  Input	:		なし
*  Return	: 		なし
*  Note		:
*
	...
	for(cnt=SV_CNT, t_no=0 ; cnt > 0 ; cnt--, t_no++) {
		switch(SV_buff[t_no].GRP_NO) {
			...
			case 92:
				...
				if ( step ) {													//目標荷重？
					SV_buff[t_no].DATA_ADR = MOT_PAGE_DAT[SV_MOT_PAGE].PRS1;	//格納先ｱﾄﾞﾚｽ変更
					SV_buff[t_no].BYTE_NO = 2;									//ﾊﾞｲﾄ長の変更
					SV_buff[t_no].TEN_POS = SYO_KAJ_CNT;						//小数点位置
					SV_buff[t_no].TOK_FLG = 0;									//特殊ﾌﾗｸﾞ
					SV_buff[t_no].SUB_NO = 123;									//ｻﾌﾞﾙｰﾁﾝNo.
			...
			case 93:
				...
				step = step_pos_prs_chk(step);
				if ( step ) {													//目標荷重？
					SV_buff[t_no].DATA_ADR = MOT_PAGE_DAT[SV_MOT_PAGE].PRS2;	//格納先ｱﾄﾞﾚｽ変更
					SV_buff[t_no].BYTE_NO = 2;									//ﾊﾞｲﾄ長の変更
					SV_buff[t_no].TEN_POS = SYO_KAJ_CNT;						//小数点位置
					SV_buff[t_no].TOK_FLG = 0;									//特殊ﾌﾗｸﾞ
					SV_buff[t_no].SUB_NO = 123;									//ｻﾌﾞﾙｰﾁﾝNo.
			...
			case 94:
				...
				step = step_pos_prs_chk(step);
				if ( step ) {													//目標荷重？
					SV_buff[t_no].DATA_ADR = MOT_PAGE_DAT[SV_MOT_PAGE].PRS3;	//格納先ｱﾄﾞﾚｽ変更
					SV_buff[t_no].BYTE_NO = 2;									//ﾊﾞｲﾄ長の変更
					SV_buff[t_no].TEN_POS = SYO_KAJ_CNT;						//小数点位置
					SV_buff[t_no].TOK_FLG = 0;									//特殊ﾌﾗｸﾞ
					SV_buff[t_no].SUB_NO = 123;									//ｻﾌﾞﾙｰﾁﾝNo.
			...
			case 95:
				...
				step = step_pos_prs_chk(step);
				if ( step ) {													//目標荷重？
					SV_buff[t_no].DATA_ADR = MOT_PAGE_DAT[SV_MOT_PAGE].PRS4;	//格納先ｱﾄﾞﾚｽ変更
					SV_buff[t_no].BYTE_NO = 2;									//ﾊﾞｲﾄ長の変更
					SV_buff[t_no].TEN_POS = SYO_KAJ_CNT;						//小数点位置
					SV_buff[t_no].TOK_FLG = 0;									//特殊ﾌﾗｸﾞ
					SV_buff[t_no].SUB_NO = 123;									//ｻﾌﾞﾙｰﾁﾝNo.
			...
			case 96:
				...
				step = step_pos_prs_chk(step);
				if ( step ) {													//目標荷重？
					SV_buff[t_no].DATA_ADR = MOT_PAGE_DAT[SV_MOT_PAGE].PRS5;	//格納先ｱﾄﾞﾚｽ変更
					SV_buff[t_no].BYTE_NO = 2;									//ﾊﾞｲﾄ長の変更
					SV_buff[t_no].TEN_POS = SYO_KAJ_CNT;						//小数点位置
					SV_buff[t_no].TOK_FLG = 0;									//特殊ﾌﾗｸﾞ
					SV_buff[t_no].SUB_NO = 123;									//ｻﾌﾞﾙｰﾁﾝNo.
...
/*
********************************************************************************
*  Function Name:	指定行程の目標確認（位置or荷重）
*  Input	:		行程No.0～99（＝1～100）
*  Return	: 		0＝目標位置  1＝目標荷重
*  Note		:
*
*  履 歴	:Shima		ON:2015-08-21
********************************************************************************
...
UNs		step_pos_prs_chk(UNs step)
{
	...
	inf = &SV_MOTTGT_INF0;
	inf += step / 16;								//位置／荷重判定領域
	bit = BIT_0;
	bit <<= step % 16;								//位置／荷重判定BIT
	if (*inf & bit) {
		ans = 1;									//目標荷重
	}
	else {
...
/*
********************************************************************************
*  Function Name:	目標角がオーバーしている行のビット情報を作成
*  Input	:		なし
*  Return	: 		なし
*  Note		:
*
...
void	mmon_agl_ovbit_make(void)
{
	...
	for (cnt=0; cnt<5; cnt++, step++, onbit<<=1) {
		if (step < SV_DANSUU_SRV) {
			if (PVP_MOT_STS[step] & cBIT1) {		//オーバーBIT ON？
				ovbit |= onbit;
			}
		}
	}
...
/*
********************************************************************************
*  Function Name:	速度がオーバーしている行のビット情報を作成
*  Input	:		なし
*  Return	: 		なし
*  Note		:
*
...
void	mmon_spd_ovbit_make(void)
{
	...
	for (cnt=0; cnt<5; cnt++, step++, onbit<<=1) {
		if (step < SV_DANSUU_SRV) {
			if (PVP_MOT_STS[step] & cBIT0) {	//オーバーBIT ON？
				ovbit |= onbit;
			}
		}
	}
	...
	if (SV_MOT_PAGE == page) {					//最終ページ？
		if (PVP_MOT_STS[99] & cBIT0) {			//オーバーBIT ON？
			ovbit |= cBIT14+cBIT15;
		}
	}
...
/*
********************************************************************************
*  Function Name:	速度が低すぎる行のビット情報を作成
*  Input	:		なし
*  Return	: 		なし
*  Note		:
*
...
////		}
		if (step < SV_DANSUU_SRV) {
			if (PVP_MOT_STS[step] & cBIT2) {	//オーバーBIT ON？
				lmbit |= onbit;
			}
		}
	}
...
////			lmbit |= cBIT14+cBIT15;
////		}
		if (PVP_MOT_STS[99] & cBIT2) {			//オーバーBIT ON？
			lmbit |= cBIT14+cBIT15;
		}
	}
...
/*
********************************************************************************
*  Function Name:	モーション実行行程のビット情報を作成
*  Input	:		なし
*  Return	: 		なし
*  Note		:
*
...
void	mmon_act_step_bit_make(void)
{
	...
	if (PVP_MOT_ACT_STEP == 0) {
		...
		page = step / 5;
		if (SV_MOT_PAGE == page) {					//実行行程は表示ページにある？
			onbit = cBIT0;
			onbit <<= step % 5;
			PV0_MOT_ACT_STEP = onbit;				//1～5行目の行程●
		}
		else {
			PV0_MOT_ACT_STEP = 0;
		}
...
/*
********************************************************************************
*  Function Name:	モーション変更行程の送信要求
*  Input	:		なし
*  Return	: 		なし
*  Note		:
*
*  履 歴	:Shimamura		ON:2015/09/23
********************************************************************************
*/
void	MOT_CHG_REQ(UNs t_no)
{
	...
	if ( (no >= 97) && (no <= 101) ) {
		...
		no = SV_MOT_PAGE * 5 + no;					//変更があった行程No.
...
/*
********************************************************************************
*  Function Name:	指定行程の変速確認（前or後）
*  Input	:		行程No.0～99（＝1～100）
*  Return	: 		0＝前  1＝後
*  Note		:
*
*  履 歴	:Shima		ON:2016/04/15
********************************************************************************
*/
