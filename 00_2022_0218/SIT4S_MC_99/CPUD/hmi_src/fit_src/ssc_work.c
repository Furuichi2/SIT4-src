...
#if (mot100_test == 1)
UNs		SV_11DANDEG_SRV;            /* 11段目目標角度 */
UNs		SV_12DANDEG_SRV;            /* 12段目目標角度 */
UNs		SV_13DANDEG_SRV;            /* 13段目目標角度 */
UNs		SV_14DANDEG_SRV;            /* 14段目目標角度 */
UNs		SV_15DANDEG_SRV;            /* 15段目目標角度 */
UNs		SV_16DANDEG_SRV;            /* 16段目目標角度 */
UNs		SV_17DANDEG_SRV;            /* 17段目目標角度 */
UNs		SV_18DANDEG_SRV;            /* 18段目目標角度 */
UNs		SV_19DANDEG_SRV;            /* 19段目目標角度 */
UNs		SV_20DANDEG_SRV;            /* 20段目目標角度 */
UNs		SV_21DANDEG_SRV;            /* 21段目目標角度 */
UNs		SV_22DANDEG_SRV;            /* 22段目目標角度 */
UNs		SV_23DANDEG_SRV;            /* 23段目目標角度 */
UNs		SV_24DANDEG_SRV;            /* 24段目目標角度 */
UNs		SV_25DANDEG_SRV;            /* 25段目目標角度 */
UNs		SV_26DANDEG_SRV;            /* 26段目目標角度 */
UNs		SV_27DANDEG_SRV;            /* 27段目目標角度 */
UNs		SV_28DANDEG_SRV;            /* 28段目目標角度 */
UNs		SV_29DANDEG_SRV;            /* 29段目目標角度 */
UNs		SV_30DANDEG_SRV;            /* 30段目目標角度 */
UNs		SV_31DANDEG_SRV;            /* 31段目目標角度 */
UNs		SV_32DANDEG_SRV;            /* 32段目目標角度 */
UNs		SV_33DANDEG_SRV;            /* 33段目目標角度 */
UNs		SV_34DANDEG_SRV;            /* 34段目目標角度 */
UNs		SV_35DANDEG_SRV;            /* 35段目目標角度 */
UNs		SV_36DANDEG_SRV;            /* 36段目目標角度 */
UNs		SV_37DANDEG_SRV;            /* 37段目目標角度 */
UNs		SV_38DANDEG_SRV;            /* 38段目目標角度 */
UNs		SV_39DANDEG_SRV;            /* 39段目目標角度 */
UNs		SV_40DANDEG_SRV;            /* 40段目目標角度 */
UNs		SV_41DANDEG_SRV;            /* 41段目目標角度 */
UNs		SV_42DANDEG_SRV;            /* 42段目目標角度 */
UNs		SV_43DANDEG_SRV;            /* 43段目目標角度 */
UNs		SV_44DANDEG_SRV;            /* 44段目目標角度 */
UNs		SV_45DANDEG_SRV;            /* 45段目目標角度 */
UNs		SV_46DANDEG_SRV;            /* 46段目目標角度 */
UNs		SV_47DANDEG_SRV;            /* 47段目目標角度 */
UNs		SV_48DANDEG_SRV;            /* 48段目目標角度 */
UNs		SV_49DANDEG_SRV;            /* 49段目目標角度 */
UNs		SV_50DANDEG_SRV;            /* 50段目目標角度 */
UNs		SV_51DANDEG_SRV;            /* 51段目目標角度 */
UNs		SV_52DANDEG_SRV;            /* 52段目目標角度 */
UNs		SV_53DANDEG_SRV;            /* 53段目目標角度 */
UNs		SV_54DANDEG_SRV;            /* 54段目目標角度 */
UNs		SV_55DANDEG_SRV;            /* 55段目目標角度 */
UNs		SV_56DANDEG_SRV;            /* 56段目目標角度 */
UNs		SV_57DANDEG_SRV;            /* 57段目目標角度 */
UNs		SV_58DANDEG_SRV;            /* 58段目目標角度 */
UNs		SV_59DANDEG_SRV;            /* 59段目目標角度 */
UNs		SV_60DANDEG_SRV;            /* 60段目目標角度 */
UNs		SV_61DANDEG_SRV;            /* 61段目目標角度 */
UNs		SV_62DANDEG_SRV;            /* 62段目目標角度 */
UNs		SV_63DANDEG_SRV;            /* 63段目目標角度 */
UNs		SV_64DANDEG_SRV;            /* 64段目目標角度 */
UNs		SV_65DANDEG_SRV;            /* 65段目目標角度 */
UNs		SV_66DANDEG_SRV;            /* 66段目目標角度 */
UNs		SV_67DANDEG_SRV;            /* 67段目目標角度 */
UNs		SV_68DANDEG_SRV;            /* 68段目目標角度 */
UNs		SV_69DANDEG_SRV;            /* 69段目目標角度 */
UNs		SV_70DANDEG_SRV;            /* 70段目目標角度 */
UNs		SV_71DANDEG_SRV;            /* 71段目目標角度 */
UNs		SV_72DANDEG_SRV;            /* 72段目目標角度 */
UNs		SV_73DANDEG_SRV;            /* 73段目目標角度 */
UNs		SV_74DANDEG_SRV;            /* 74段目目標角度 */
UNs		SV_75DANDEG_SRV;            /* 75段目目標角度 */
UNs		SV_76DANDEG_SRV;            /* 76段目目標角度 */
UNs		SV_77DANDEG_SRV;            /* 77段目目標角度 */
UNs		SV_78DANDEG_SRV;            /* 78段目目標角度 */
UNs		SV_79DANDEG_SRV;            /* 79段目目標角度 */
UNs		SV_80DANDEG_SRV;            /* 80段目目標角度 */
UNs		SV_81DANDEG_SRV;            /* 81段目目標角度 */
UNs		SV_82DANDEG_SRV;            /* 82段目目標角度 */
UNs		SV_83DANDEG_SRV;            /* 83段目目標角度 */
UNs		SV_84DANDEG_SRV;            /* 84段目目標角度 */
UNs		SV_85DANDEG_SRV;            /* 85段目目標角度 */
UNs		SV_86DANDEG_SRV;            /* 86段目目標角度 */
UNs		SV_87DANDEG_SRV;            /* 87段目目標角度 */
UNs		SV_88DANDEG_SRV;            /* 88段目目標角度 */
UNs		SV_89DANDEG_SRV;            /* 89段目目標角度 */
UNs		SV_90DANDEG_SRV;            /* 90段目目標角度 */
UNs		SV_91DANDEG_SRV;            /* 91段目目標角度 */
UNs		SV_92DANDEG_SRV;            /* 92段目目標角度 */
UNs		SV_93DANDEG_SRV;            /* 93段目目標角度 */
UNs		SV_94DANDEG_SRV;            /* 94段目目標角度 */
UNs		SV_95DANDEG_SRV;            /* 95段目目標角度 */
UNs		SV_96DANDEG_SRV;            /* 96段目目標角度 */
UNs		SV_97DANDEG_SRV;            /* 97段目目標角度 */
UNs		SV_98DANDEG_SRV;            /* 98段目目標角度 */
UNs		SV_99DANDEG_SRV;            /* 99段目目標角度 */
UNs		SV_100DANDEG_SRV;           /* 100段目目標角度 */
#endif
...
#if (mot100_test == 1)
UNl		SV_11DANPOS_SRV;            /* 11段目目標位置 */
UNl		SV_12DANPOS_SRV;            /* 12段目目標位置 */
UNl		SV_13DANPOS_SRV;            /* 13段目目標位置 */
UNl		SV_14DANPOS_SRV;            /* 14段目目標位置 */
UNl		SV_15DANPOS_SRV;            /* 15段目目標位置 */
UNl		SV_16DANPOS_SRV;            /* 16段目目標位置 */
UNl		SV_17DANPOS_SRV;            /* 17段目目標位置 */
UNl		SV_18DANPOS_SRV;            /* 18段目目標位置 */
UNl		SV_19DANPOS_SRV;            /* 19段目目標位置 */
UNl		SV_20DANPOS_SRV;            /* 20段目目標位置 */
UNl		SV_21DANPOS_SRV;            /* 21段目目標位置 */
UNl		SV_22DANPOS_SRV;            /* 22段目目標位置 */
UNl		SV_23DANPOS_SRV;            /* 23段目目標位置 */
UNl		SV_24DANPOS_SRV;            /* 24段目目標位置 */
UNl		SV_25DANPOS_SRV;            /* 25段目目標位置 */
UNl		SV_26DANPOS_SRV;            /* 26段目目標位置 */
UNl		SV_27DANPOS_SRV;            /* 27段目目標位置 */
UNl		SV_28DANPOS_SRV;            /* 28段目目標位置 */
UNl		SV_29DANPOS_SRV;            /* 29段目目標位置 */
UNl		SV_30DANPOS_SRV;            /* 30段目目標位置 */
UNl		SV_31DANPOS_SRV;            /* 31段目目標位置 */
UNl		SV_32DANPOS_SRV;            /* 32段目目標位置 */
UNl		SV_33DANPOS_SRV;            /* 33段目目標位置 */
UNl		SV_34DANPOS_SRV;            /* 34段目目標位置 */
UNl		SV_35DANPOS_SRV;            /* 35段目目標位置 */
UNl		SV_36DANPOS_SRV;            /* 36段目目標位置 */
UNl		SV_37DANPOS_SRV;            /* 37段目目標位置 */
UNl		SV_38DANPOS_SRV;            /* 38段目目標位置 */
UNl		SV_39DANPOS_SRV;            /* 39段目目標位置 */
UNl		SV_40DANPOS_SRV;            /* 40段目目標位置 */
UNl		SV_41DANPOS_SRV;            /* 41段目目標位置 */
UNl		SV_42DANPOS_SRV;            /* 42段目目標位置 */
UNl		SV_43DANPOS_SRV;            /* 43段目目標位置 */
UNl		SV_44DANPOS_SRV;            /* 44段目目標位置 */
UNl		SV_45DANPOS_SRV;            /* 45段目目標位置 */
UNl		SV_46DANPOS_SRV;            /* 46段目目標位置 */
UNl		SV_47DANPOS_SRV;            /* 47段目目標位置 */
UNl		SV_48DANPOS_SRV;            /* 48段目目標位置 */
UNl		SV_49DANPOS_SRV;            /* 49段目目標位置 */
UNl		SV_50DANPOS_SRV;            /* 50段目目標位置 */
UNl		SV_51DANPOS_SRV;            /* 51段目目標位置 */
UNl		SV_52DANPOS_SRV;            /* 52段目目標位置 */
UNl		SV_53DANPOS_SRV;            /* 53段目目標位置 */
UNl		SV_54DANPOS_SRV;            /* 54段目目標位置 */
UNl		SV_55DANPOS_SRV;            /* 55段目目標位置 */
UNl		SV_56DANPOS_SRV;            /* 56段目目標位置 */
UNl		SV_57DANPOS_SRV;            /* 57段目目標位置 */
UNl		SV_58DANPOS_SRV;            /* 58段目目標位置 */
UNl		SV_59DANPOS_SRV;            /* 59段目目標位置 */
UNl		SV_60DANPOS_SRV;            /* 60段目目標位置 */
UNl		SV_61DANPOS_SRV;            /* 61段目目標位置 */
UNl		SV_62DANPOS_SRV;            /* 62段目目標位置 */
UNl		SV_63DANPOS_SRV;            /* 63段目目標位置 */
UNl		SV_64DANPOS_SRV;            /* 64段目目標位置 */
UNl		SV_65DANPOS_SRV;            /* 65段目目標位置 */
UNl		SV_66DANPOS_SRV;            /* 66段目目標位置 */
UNl		SV_67DANPOS_SRV;            /* 67段目目標位置 */
UNl		SV_68DANPOS_SRV;            /* 68段目目標位置 */
UNl		SV_69DANPOS_SRV;            /* 69段目目標位置 */
UNl		SV_70DANPOS_SRV;            /* 70段目目標位置 */
UNl		SV_71DANPOS_SRV;            /* 71段目目標位置 */
UNl		SV_72DANPOS_SRV;            /* 72段目目標位置 */
UNl		SV_73DANPOS_SRV;            /* 73段目目標位置 */
UNl		SV_74DANPOS_SRV;            /* 74段目目標位置 */
UNl		SV_75DANPOS_SRV;            /* 75段目目標位置 */
UNl		SV_76DANPOS_SRV;            /* 76段目目標位置 */
UNl		SV_77DANPOS_SRV;            /* 77段目目標位置 */
UNl		SV_78DANPOS_SRV;            /* 78段目目標位置 */
UNl		SV_79DANPOS_SRV;            /* 79段目目標位置 */
UNl		SV_80DANPOS_SRV;            /* 80段目目標位置 */
UNl		SV_81DANPOS_SRV;            /* 81段目目標位置 */
UNl		SV_82DANPOS_SRV;            /* 82段目目標位置 */
UNl		SV_83DANPOS_SRV;            /* 83段目目標位置 */
UNl		SV_84DANPOS_SRV;            /* 84段目目標位置 */
UNl		SV_85DANPOS_SRV;            /* 85段目目標位置 */
UNl		SV_86DANPOS_SRV;            /* 86段目目標位置 */
UNl		SV_87DANPOS_SRV;            /* 87段目目標位置 */
UNl		SV_88DANPOS_SRV;            /* 88段目目標位置 */
UNl		SV_89DANPOS_SRV;            /* 89段目目標位置 */
UNl		SV_90DANPOS_SRV;            /* 90段目目標位置 */
UNl		SV_91DANPOS_SRV;            /* 91段目目標位置 */
UNl		SV_92DANPOS_SRV;            /* 92段目目標位置 */
UNl		SV_93DANPOS_SRV;            /* 93段目目標位置 */
UNl		SV_94DANPOS_SRV;            /* 94段目目標位置 */
UNl		SV_95DANPOS_SRV;            /* 95段目目標位置 */
UNl		SV_96DANPOS_SRV;            /* 96段目目標位置 */
UNl		SV_97DANPOS_SRV;            /* 97段目目標位置 */
UNl		SV_98DANPOS_SRV;            /* 98段目目標位置 */
UNl		SV_99DANPOS_SRV;            /* 99段目目標位置 */
UNl		SV_100DANPOS_SRV;           /* 100段目目標位置 */
#endif
...
#if (mot100_test == 1)
UNs		SV_11DANSPD_SRV;            /* 11段目移動速度 */
UNs		SV_12DANSPD_SRV;            /* 12段目移動速度 */
UNs		SV_13DANSPD_SRV;            /* 13段目移動速度 */
UNs		SV_14DANSPD_SRV;            /* 14段目移動速度 */
UNs		SV_15DANSPD_SRV;            /* 15段目移動速度 */
UNs		SV_16DANSPD_SRV;            /* 16段目移動速度 */
UNs		SV_17DANSPD_SRV;            /* 17段目移動速度 */
UNs		SV_18DANSPD_SRV;            /* 18段目移動速度 */
UNs		SV_19DANSPD_SRV;            /* 19段目移動速度 */
UNs		SV_20DANSPD_SRV;            /* 20段目移動速度 */
UNs		SV_21DANSPD_SRV;            /* 21段目移動速度 */
UNs		SV_22DANSPD_SRV;            /* 22段目移動速度 */
UNs		SV_23DANSPD_SRV;            /* 23段目移動速度 */
UNs		SV_24DANSPD_SRV;            /* 24段目移動速度 */
UNs		SV_25DANSPD_SRV;            /* 25段目移動速度 */
UNs		SV_26DANSPD_SRV;            /* 26段目移動速度 */
UNs		SV_27DANSPD_SRV;            /* 27段目移動速度 */
UNs		SV_28DANSPD_SRV;            /* 28段目移動速度 */
UNs		SV_29DANSPD_SRV;            /* 29段目移動速度 */
UNs		SV_30DANSPD_SRV;            /* 30段目移動速度 */
UNs		SV_31DANSPD_SRV;            /* 31段目移動速度 */
UNs		SV_32DANSPD_SRV;            /* 32段目移動速度 */
UNs		SV_33DANSPD_SRV;            /* 33段目移動速度 */
UNs		SV_34DANSPD_SRV;            /* 34段目移動速度 */
UNs		SV_35DANSPD_SRV;            /* 35段目移動速度 */
UNs		SV_36DANSPD_SRV;            /* 36段目移動速度 */
UNs		SV_37DANSPD_SRV;            /* 37段目移動速度 */
UNs		SV_38DANSPD_SRV;            /* 38段目移動速度 */
UNs		SV_39DANSPD_SRV;            /* 39段目移動速度 */
UNs		SV_40DANSPD_SRV;            /* 40段目移動速度 */
UNs		SV_41DANSPD_SRV;            /* 41段目移動速度 */
UNs		SV_42DANSPD_SRV;            /* 42段目移動速度 */
UNs		SV_43DANSPD_SRV;            /* 43段目移動速度 */
UNs		SV_44DANSPD_SRV;            /* 44段目移動速度 */
UNs		SV_45DANSPD_SRV;            /* 45段目移動速度 */
UNs		SV_46DANSPD_SRV;            /* 46段目移動速度 */
UNs		SV_47DANSPD_SRV;            /* 47段目移動速度 */
UNs		SV_48DANSPD_SRV;            /* 48段目移動速度 */
UNs		SV_49DANSPD_SRV;            /* 49段目移動速度 */
UNs		SV_50DANSPD_SRV;            /* 50段目移動速度 */
UNs		SV_51DANSPD_SRV;            /* 51段目移動速度 */
UNs		SV_52DANSPD_SRV;            /* 52段目移動速度 */
UNs		SV_53DANSPD_SRV;            /* 53段目移動速度 */
UNs		SV_54DANSPD_SRV;            /* 54段目移動速度 */
UNs		SV_55DANSPD_SRV;            /* 55段目移動速度 */
UNs		SV_56DANSPD_SRV;            /* 56段目移動速度 */
UNs		SV_57DANSPD_SRV;            /* 57段目移動速度 */
UNs		SV_58DANSPD_SRV;            /* 58段目移動速度 */
UNs		SV_59DANSPD_SRV;            /* 59段目移動速度 */
UNs		SV_60DANSPD_SRV;            /* 60段目移動速度 */
UNs		SV_61DANSPD_SRV;            /* 61段目移動速度 */
UNs		SV_62DANSPD_SRV;            /* 62段目移動速度 */
UNs		SV_63DANSPD_SRV;            /* 63段目移動速度 */
UNs		SV_64DANSPD_SRV;            /* 64段目移動速度 */
UNs		SV_65DANSPD_SRV;            /* 65段目移動速度 */
UNs		SV_66DANSPD_SRV;            /* 66段目移動速度 */
UNs		SV_67DANSPD_SRV;            /* 67段目移動速度 */
UNs		SV_68DANSPD_SRV;            /* 68段目移動速度 */
UNs		SV_69DANSPD_SRV;            /* 69段目移動速度 */
UNs		SV_70DANSPD_SRV;            /* 70段目移動速度 */
UNs		SV_71DANSPD_SRV;            /* 71段目移動速度 */
UNs		SV_72DANSPD_SRV;            /* 72段目移動速度 */
UNs		SV_73DANSPD_SRV;            /* 73段目移動速度 */
UNs		SV_74DANSPD_SRV;            /* 74段目移動速度 */
UNs		SV_75DANSPD_SRV;            /* 75段目移動速度 */
UNs		SV_76DANSPD_SRV;            /* 76段目移動速度 */
UNs		SV_77DANSPD_SRV;            /* 77段目移動速度 */
UNs		SV_78DANSPD_SRV;            /* 78段目移動速度 */
UNs		SV_79DANSPD_SRV;            /* 79段目移動速度 */
UNs		SV_80DANSPD_SRV;            /* 80段目移動速度 */
UNs		SV_81DANSPD_SRV;            /* 81段目移動速度 */
UNs		SV_82DANSPD_SRV;            /* 82段目移動速度 */
UNs		SV_83DANSPD_SRV;            /* 83段目移動速度 */
UNs		SV_84DANSPD_SRV;            /* 84段目移動速度 */
UNs		SV_85DANSPD_SRV;            /* 85段目移動速度 */
UNs		SV_86DANSPD_SRV;            /* 86段目移動速度 */
UNs		SV_87DANSPD_SRV;            /* 87段目移動速度 */
UNs		SV_88DANSPD_SRV;            /* 88段目移動速度 */
UNs		SV_89DANSPD_SRV;            /* 89段目移動速度 */
UNs		SV_90DANSPD_SRV;            /* 90段目移動速度 */
UNs		SV_91DANSPD_SRV;            /* 91段目移動速度 */
UNs		SV_92DANSPD_SRV;            /* 92段目移動速度 */
UNs		SV_93DANSPD_SRV;            /* 93段目移動速度 */
UNs		SV_94DANSPD_SRV;            /* 94段目移動速度 */
UNs		SV_95DANSPD_SRV;            /* 95段目移動速度 */
UNs		SV_96DANSPD_SRV;            /* 96段目移動速度 */
UNs		SV_97DANSPD_SRV;            /* 97段目移動速度 */
UNs		SV_98DANSPD_SRV;            /* 98段目移動速度 */
UNs		SV_99DANSPD_SRV;            /* 99段目移動速度 */
UNs		SV_100DANSPD_SRV;           /* 100段目移動速度 */
#endif
...
#if (mot100_test == 1)
UNs		SV_11DANTIM_SRV;            /* 11段目停止時間 */
UNs		SV_12DANTIM_SRV;            /* 12段目停止時間 */
UNs		SV_13DANTIM_SRV;            /* 13段目停止時間 */
UNs		SV_14DANTIM_SRV;            /* 14段目停止時間 */
UNs		SV_15DANTIM_SRV;            /* 15段目停止時間 */
UNs		SV_16DANTIM_SRV;            /* 16段目停止時間 */
UNs		SV_17DANTIM_SRV;            /* 17段目停止時間 */
UNs		SV_18DANTIM_SRV;            /* 18段目停止時間 */
UNs		SV_19DANTIM_SRV;            /* 19段目停止時間 */
UNs		SV_20DANTIM_SRV;            /* 20段目停止時間 */
UNs		SV_21DANTIM_SRV;            /* 21段目停止時間 */
UNs		SV_22DANTIM_SRV;            /* 22段目停止時間 */
UNs		SV_23DANTIM_SRV;            /* 23段目停止時間 */
UNs		SV_24DANTIM_SRV;            /* 24段目停止時間 */
UNs		SV_25DANTIM_SRV;            /* 25段目停止時間 */
UNs		SV_26DANTIM_SRV;            /* 26段目停止時間 */
UNs		SV_27DANTIM_SRV;            /* 27段目停止時間 */
UNs		SV_28DANTIM_SRV;            /* 28段目停止時間 */
UNs		SV_29DANTIM_SRV;            /* 29段目停止時間 */
UNs		SV_30DANTIM_SRV;            /* 30段目停止時間 */
UNs		SV_31DANTIM_SRV;            /* 31段目停止時間 */
UNs		SV_32DANTIM_SRV;            /* 32段目停止時間 */
UNs		SV_33DANTIM_SRV;            /* 33段目停止時間 */
UNs		SV_34DANTIM_SRV;            /* 34段目停止時間 */
UNs		SV_35DANTIM_SRV;            /* 35段目停止時間 */
UNs		SV_36DANTIM_SRV;            /* 36段目停止時間 */
UNs		SV_37DANTIM_SRV;            /* 37段目停止時間 */
UNs		SV_38DANTIM_SRV;            /* 38段目停止時間 */
UNs		SV_39DANTIM_SRV;            /* 39段目停止時間 */
UNs		SV_40DANTIM_SRV;            /* 40段目停止時間 */
UNs		SV_41DANTIM_SRV;            /* 41段目停止時間 */
UNs		SV_42DANTIM_SRV;            /* 42段目停止時間 */
UNs		SV_43DANTIM_SRV;            /* 43段目停止時間 */
UNs		SV_44DANTIM_SRV;            /* 44段目停止時間 */
UNs		SV_45DANTIM_SRV;            /* 45段目停止時間 */
UNs		SV_46DANTIM_SRV;            /* 46段目停止時間 */
UNs		SV_47DANTIM_SRV;            /* 47段目停止時間 */
UNs		SV_48DANTIM_SRV;            /* 48段目停止時間 */
UNs		SV_49DANTIM_SRV;            /* 49段目停止時間 */
UNs		SV_50DANTIM_SRV;            /* 50段目停止時間 */
UNs		SV_51DANTIM_SRV;            /* 51段目停止時間 */
UNs		SV_52DANTIM_SRV;            /* 52段目停止時間 */
UNs		SV_53DANTIM_SRV;            /* 53段目停止時間 */
UNs		SV_54DANTIM_SRV;            /* 54段目停止時間 */
UNs		SV_55DANTIM_SRV;            /* 55段目停止時間 */
UNs		SV_56DANTIM_SRV;            /* 56段目停止時間 */
UNs		SV_57DANTIM_SRV;            /* 57段目停止時間 */
UNs		SV_58DANTIM_SRV;            /* 58段目停止時間 */
UNs		SV_59DANTIM_SRV;            /* 59段目停止時間 */
UNs		SV_60DANTIM_SRV;            /* 60段目停止時間 */
UNs		SV_61DANTIM_SRV;            /* 61段目停止時間 */
UNs		SV_62DANTIM_SRV;            /* 62段目停止時間 */
UNs		SV_63DANTIM_SRV;            /* 63段目停止時間 */
UNs		SV_64DANTIM_SRV;            /* 64段目停止時間 */
UNs		SV_65DANTIM_SRV;            /* 65段目停止時間 */
UNs		SV_66DANTIM_SRV;            /* 66段目停止時間 */
UNs		SV_67DANTIM_SRV;            /* 67段目停止時間 */
UNs		SV_68DANTIM_SRV;            /* 68段目停止時間 */
UNs		SV_69DANTIM_SRV;            /* 69段目停止時間 */
UNs		SV_70DANTIM_SRV;            /* 70段目停止時間 */
UNs		SV_71DANTIM_SRV;            /* 71段目停止時間 */
UNs		SV_72DANTIM_SRV;            /* 72段目停止時間 */
UNs		SV_73DANTIM_SRV;            /* 73段目停止時間 */
UNs		SV_74DANTIM_SRV;            /* 74段目停止時間 */
UNs		SV_75DANTIM_SRV;            /* 75段目停止時間 */
UNs		SV_76DANTIM_SRV;            /* 76段目停止時間 */
UNs		SV_77DANTIM_SRV;            /* 77段目停止時間 */
UNs		SV_78DANTIM_SRV;            /* 78段目停止時間 */
UNs		SV_79DANTIM_SRV;            /* 79段目停止時間 */
UNs		SV_80DANTIM_SRV;            /* 80段目停止時間 */
UNs		SV_81DANTIM_SRV;            /* 81段目停止時間 */
UNs		SV_82DANTIM_SRV;            /* 82段目停止時間 */
UNs		SV_83DANTIM_SRV;            /* 83段目停止時間 */
UNs		SV_84DANTIM_SRV;            /* 84段目停止時間 */
UNs		SV_85DANTIM_SRV;            /* 85段目停止時間 */
UNs		SV_86DANTIM_SRV;            /* 86段目停止時間 */
UNs		SV_87DANTIM_SRV;            /* 87段目停止時間 */
UNs		SV_88DANTIM_SRV;            /* 88段目停止時間 */
UNs		SV_89DANTIM_SRV;            /* 89段目停止時間 */
UNs		SV_90DANTIM_SRV;            /* 90段目停止時間 */
UNs		SV_91DANTIM_SRV;            /* 91段目停止時間 */
UNs		SV_92DANTIM_SRV;            /* 92段目停止時間 */
UNs		SV_93DANTIM_SRV;            /* 93段目停止時間 */
UNs		SV_94DANTIM_SRV;            /* 94段目停止時間 */
UNs		SV_95DANTIM_SRV;            /* 95段目停止時間 */
UNs		SV_96DANTIM_SRV;            /* 96段目停止時間 */
UNs		SV_97DANTIM_SRV;            /* 97段目停止時間 */
UNs		SV_98DANTIM_SRV;            /* 98段目停止時間 */
UNs		SV_99DANTIM_SRV;            /* 99段目停止時間 */
UNs		SV_100DANTIM_SRV;           /* 100段目停止時間 */
#endif
...
SV_TBL_TDEF		SV_buff[100];		/* 設定値情報テーブル定義領域	*/
...
#if (mot100_test == 1)
UNs		SV_11DANPRS_SRV;            /* 11段目目標荷重 */
UNs		SV_12DANPRS_SRV;            /* 12段目目標荷重 */
UNs		SV_13DANPRS_SRV;            /* 13段目目標荷重 */
UNs		SV_14DANPRS_SRV;            /* 14段目目標荷重 */
UNs		SV_15DANPRS_SRV;            /* 15段目目標荷重 */
UNs		SV_16DANPRS_SRV;            /* 16段目目標荷重 */
UNs		SV_17DANPRS_SRV;            /* 17段目目標荷重 */
UNs		SV_18DANPRS_SRV;            /* 18段目目標荷重 */
UNs		SV_19DANPRS_SRV;            /* 19段目目標荷重 */
UNs		SV_20DANPRS_SRV;            /* 20段目目標荷重 */
UNs		SV_21DANPRS_SRV;            /* 21段目目標荷重 */
UNs		SV_22DANPRS_SRV;            /* 22段目目標荷重 */
UNs		SV_23DANPRS_SRV;            /* 23段目目標荷重 */
UNs		SV_24DANPRS_SRV;            /* 24段目目標荷重 */
UNs		SV_25DANPRS_SRV;            /* 25段目目標荷重 */
UNs		SV_26DANPRS_SRV;            /* 26段目目標荷重 */
UNs		SV_27DANPRS_SRV;            /* 27段目目標荷重 */
UNs		SV_28DANPRS_SRV;            /* 28段目目標荷重 */
UNs		SV_29DANPRS_SRV;            /* 29段目目標荷重 */
UNs		SV_30DANPRS_SRV;            /* 30段目目標荷重 */
UNs		SV_31DANPRS_SRV;            /* 31段目目標荷重 */
UNs		SV_32DANPRS_SRV;            /* 32段目目標荷重 */
UNs		SV_33DANPRS_SRV;            /* 33段目目標荷重 */
UNs		SV_34DANPRS_SRV;            /* 34段目目標荷重 */
UNs		SV_35DANPRS_SRV;            /* 35段目目標荷重 */
UNs		SV_36DANPRS_SRV;            /* 36段目目標荷重 */
UNs		SV_37DANPRS_SRV;            /* 37段目目標荷重 */
UNs		SV_38DANPRS_SRV;            /* 38段目目標荷重 */
UNs		SV_39DANPRS_SRV;            /* 39段目目標荷重 */
UNs		SV_40DANPRS_SRV;            /* 40段目目標荷重 */
UNs		SV_41DANPRS_SRV;            /* 41段目目標荷重 */
UNs		SV_42DANPRS_SRV;            /* 42段目目標荷重 */
UNs		SV_43DANPRS_SRV;            /* 43段目目標荷重 */
UNs		SV_44DANPRS_SRV;            /* 44段目目標荷重 */
UNs		SV_45DANPRS_SRV;            /* 45段目目標荷重 */
UNs		SV_46DANPRS_SRV;            /* 46段目目標荷重 */
UNs		SV_47DANPRS_SRV;            /* 47段目目標荷重 */
UNs		SV_48DANPRS_SRV;            /* 48段目目標荷重 */
UNs		SV_49DANPRS_SRV;            /* 49段目目標荷重 */
UNs		SV_50DANPRS_SRV;            /* 50段目目標荷重 */
UNs		SV_51DANPRS_SRV;            /* 51段目目標荷重 */
UNs		SV_52DANPRS_SRV;            /* 52段目目標荷重 */
UNs		SV_53DANPRS_SRV;            /* 53段目目標荷重 */
UNs		SV_54DANPRS_SRV;            /* 54段目目標荷重 */
UNs		SV_55DANPRS_SRV;            /* 55段目目標荷重 */
UNs		SV_56DANPRS_SRV;            /* 56段目目標荷重 */
UNs		SV_57DANPRS_SRV;            /* 57段目目標荷重 */
UNs		SV_58DANPRS_SRV;            /* 58段目目標荷重 */
UNs		SV_59DANPRS_SRV;            /* 59段目目標荷重 */
UNs		SV_60DANPRS_SRV;            /* 60段目目標荷重 */
UNs		SV_61DANPRS_SRV;            /* 61段目目標荷重 */
UNs		SV_62DANPRS_SRV;            /* 62段目目標荷重 */
UNs		SV_63DANPRS_SRV;            /* 63段目目標荷重 */
UNs		SV_64DANPRS_SRV;            /* 64段目目標荷重 */
UNs		SV_65DANPRS_SRV;            /* 65段目目標荷重 */
UNs		SV_66DANPRS_SRV;            /* 66段目目標荷重 */
UNs		SV_67DANPRS_SRV;            /* 67段目目標荷重 */
UNs		SV_68DANPRS_SRV;            /* 68段目目標荷重 */
UNs		SV_69DANPRS_SRV;            /* 69段目目標荷重 */
UNs		SV_70DANPRS_SRV;            /* 70段目目標荷重 */
UNs		SV_71DANPRS_SRV;            /* 71段目目標荷重 */
UNs		SV_72DANPRS_SRV;            /* 72段目目標荷重 */
UNs		SV_73DANPRS_SRV;            /* 73段目目標荷重 */
UNs		SV_74DANPRS_SRV;            /* 74段目目標荷重 */
UNs		SV_75DANPRS_SRV;            /* 75段目目標荷重 */
UNs		SV_76DANPRS_SRV;            /* 76段目目標荷重 */
UNs		SV_77DANPRS_SRV;            /* 77段目目標荷重 */
UNs		SV_78DANPRS_SRV;            /* 78段目目標荷重 */
UNs		SV_79DANPRS_SRV;            /* 79段目目標荷重 */
UNs		SV_80DANPRS_SRV;            /* 80段目目標荷重 */
UNs		SV_81DANPRS_SRV;            /* 81段目目標荷重 */
UNs		SV_82DANPRS_SRV;            /* 82段目目標荷重 */
UNs		SV_83DANPRS_SRV;            /* 83段目目標荷重 */
UNs		SV_84DANPRS_SRV;            /* 84段目目標荷重 */
UNs		SV_85DANPRS_SRV;            /* 85段目目標荷重 */
UNs		SV_86DANPRS_SRV;            /* 86段目目標荷重 */
UNs		SV_87DANPRS_SRV;            /* 87段目目標荷重 */
UNs		SV_88DANPRS_SRV;            /* 88段目目標荷重 */
UNs		SV_89DANPRS_SRV;            /* 89段目目標荷重 */
UNs		SV_90DANPRS_SRV;            /* 90段目目標荷重 */
UNs		SV_91DANPRS_SRV;            /* 91段目目標荷重 */
UNs		SV_92DANPRS_SRV;            /* 92段目目標荷重 */
UNs		SV_93DANPRS_SRV;            /* 93段目目標荷重 */
UNs		SV_94DANPRS_SRV;            /* 94段目目標荷重 */
UNs		SV_95DANPRS_SRV;            /* 95段目目標荷重 */
UNs		SV_96DANPRS_SRV;            /* 96段目目標荷重 */
UNs		SV_97DANPRS_SRV;            /* 97段目目標荷重 */
UNs		SV_98DANPRS_SRV;            /* 98段目目標荷重 */
UNs		SV_99DANPRS_SRV;            /* 99段目目標荷重 */
UNs		SV_100DANPRS_SRV;           /* 100段目目標荷重 */
#endif
...
//;	******** モーション100段対応 ***********
#if (mot100_test == 1)
UNs		SV_MOTTGT_INF0;				//目標位置／荷重切替BIT情報
UNs		SV_MOTTGT_INF1;				//目標位置／荷重切替BIT情報
UNs		SV_MOTTGT_INF2;				//目標位置／荷重切替BIT情報
UNs		SV_MOTTGT_INF3;				//目標位置／荷重切替BIT情報
UNs		SV_MOTTGT_INF4;				//目標位置／荷重切替BIT情報
UNs		SV_MOTTGT_INF5;				//目標位置／荷重切替BIT情報
UNs		SV_MOTTGT_INF6;				//目標位置／荷重切替BIT情報
UNl		CAR_DO_AREA;				//単位(°)
UNl		CAR_PAR_AREA;				//単位(%)
UNl		CAR_TIM_AREA;				//単位(s)
UNs		SV0_DISP_STEP_NO[5];		//モーション画面の表示する行程No.
UNs		PV0_MOT_ACT_STEP;			//モーション画面で実行行程のビット情報（●表示用）
UNs		csr_disp_wk[16];

//UNs		PVP_CKAGL_OVBIT1[7];		//本当はDPRAM（後で小松さんと相談、直接割付orﾃﾞｰﾀ分割送信）
//UNs		PVP_CKLMT_AGLTOP1[100];		//本当はDPRAM（後で小松さんと相談、直接割付orﾃﾞｰﾀ分割送信）
//UNs		PVP_CKSPD_OVBIT1[7];		//本当はDPRAM（後で小松さんと相談、直接割付orﾃﾞｰﾀ分割送信）
//UNs		PVP_CKLMT_SPDTOP1[100];		//本当はDPRAM（後で小松さんと相談、直接割付orﾃﾞｰﾀ分割送信）
//UNs		PVP_CKSPD_LMBIT1[7];		//本当はDPRAM（後で小松さんと相談、直接割付orﾃﾞｰﾀ分割送信）
...
//;	******** フィーダ対応 ***********		2016/03/18
UNl		PV0_LFEED_POS;					//ﾚﾍﾞﾗﾌｨｰﾀﾞ現在位置
UNs		SV0_LFEED_SEL;					//ﾚﾍﾞﾗﾌｨｰﾀﾞ有無
UNs		SV0_LFEED_HSIS;					//ﾚﾍﾞﾗﾌｨｰﾀﾞ矯正量入口符号
UNs		SV0_LFEED_HSOS;					//ﾚﾍﾞﾗﾌｨｰﾀﾞ矯正量出口符号
UNb		PV0_LFEED_TYPE[16];				//ﾚﾍﾞﾗﾌｨｰﾀﾞ型式ASCII
UNs		SYS0_FEED_PAR_BLK[32];			//現在のﾚﾍﾞﾗﾌｨｰﾀﾞ関連のROMﾊﾟﾗ

//;	******** ﾓｰｼｮﾝ10段→100段対応 ***********		2016/04/01
UNs		kata_mot010_work[0x800/2];
UNs		kata_mot100_work[0x1800/2];

//;	******** ﾓｰｼｮﾝ加減速対応 ***********		2016/04/15
UNs		SV0_MOT_UDSEL;					//加減速有効／無効
UNs		SV0_MOT_BFAF;					//モーション表示ページ5段分の加減速情報
UNs		SV_MOT_CSUD_INF0;				//加減速情報（1～16行程）
UNs		SV_MOT_CSUD_INF1;				//加減速情報（17～32行程）
UNs		SV_MOT_CSUD_INF2;				//加減速情報（33～48行程）
UNs		SV_MOT_CSUD_INF3;				//加減速情報（49～64行程）
UNs		SV_MOT_CSUD_INF4;				//加減速情報（65～80行程）
UNs		SV_MOT_CSUD_INF5;				//加減速情報（81～96行程）
UNs		SV_MOT_CSUD_INF6;				//加減速情報（97～100行程）
