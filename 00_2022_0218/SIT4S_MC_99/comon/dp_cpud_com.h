...
//;	=== 2015/09/28 ===	SHIMA
	extern	U2b	SVP_MOT_PAGE			;//ﾓｰｼｮﾝ画面表示ﾍﾟｰｼﾞ
	extern	U2b	SVP_MOT_CSR_STEP		;//ﾓｰｼｮﾝ画面でｶｰｿﾙがある行程No.
	extern	U2b	SVP_MOT_SEND_REQ		;//ﾓｰｼｮﾝﾃﾞｰﾀ送信段No.
	extern	U4b	SVP_OBJECT_PS			;//目標位置
	extern	U2b	SVP_OBJECT_DG			;//目標角度
	extern	U2b	SVP_OBJECT_SP			;//目標速度
	extern	U2b	SVP_OBJECT_TM			;//停止時間
	extern	U2b	SVP_OBJECT_PRS			;//目標圧力
	extern	U2b	SVP_MOT_INF				;//ﾓｰｼｮﾝ情報
	extern	U2b	SVP_FED_DEG				;//ﾌｨｰﾀﾞ角度
	extern	U4b	SVP_FED_POS				;//ﾌｨｰﾀﾞ位置
...
//;	=== 2016-03-20 ﾚﾍﾞﾙﾌｨｰﾀﾞの意味で"LFEED"で統一する(上がALIGN 4だからOK)=====
	extern	U4b	SVP_LFEED_LNG1		;//.SRES	4	;送り長さ　0.01mm
	extern	U4b	SVP_LFEED_STRPOS	;//.SRES	4	;送り開始位置 0.001mm
	extern	U2b	SVP_LFEED_STRDEG	;//.SRES	2	;送り開始角度 0.1度
	extern	U2b	SVP_LFEED_STRNO		;//.SRES	2	;送り開始行程		
	extern	U4b	SVP_LFEED_ENDPOS	;//.SRES	4	;送り終了位置 0.001mm
	extern	U2b	SVP_LFEED_ENDDEG	;//.SRES	2	;送り終了角度 0.1度
	extern	U2b	SVP_LFEED_ENDNO		;//.SRES	2	;送り終了行程
	extern	U2b	SVP_LFEED_SPD1		;//.SRES	2	;通常の送り速度1%
	extern	U2b	SVP_LFEED_SPD2		;//.SRES	2	;低速の送り速度1%
	extern	U2b	SVP_LFEED_SELNO		;//.SRES	2	;型式の選択番号
	extern	S2b	SVP_LFEED_HOSIN		;//.SRES	2	;矯正量(ｸﾘｱﾗﾝｽ) 入口
	extern	S2b	SVP_LFEED_HOSOT		;//.SRES	2	;矯正量(ｸﾘｱﾗﾝｽ) 出口
	extern	U2b	SVP_LFEED_GMNSQ1	;//.SRES	2	;ｼｰｹﾝｽ396
	extern	U2b	SVP_LFEED_GMNSQ2	;//.SRES	2	;ｼｰｹﾝｽ397
	extern	U2b	SVP_LFEED_GMNSQ3	;//.SRES	2	;ｼｰｹﾝｽ398
	extern	U2b	SVP_LFEED_GMNSQ4	;//.SRES	2	;ｼｰｹﾝｽ399

//;	=== 2016/11/15 ロータリカムタイマ仕様 =====
	extern	U2b	SVP_RCAMON_P110		;// ロータリカム１　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D110		;// ロータリカム１　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P110		;// ロータリカム１　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D110		;// ロータリカム１　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P111		;// ロータリカム２　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D111		;// ロータリカム２　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P111		;// ロータリカム２　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D111		;// ロータリカム２　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P112		;// ロータリカム３　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D112		;// ロータリカム３　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P112		;// ロータリカム３　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D112		;// ロータリカム３　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P113		;// ロータリカム４　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D113		;// ロータリカム４　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P113		;// ロータリカム４　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D113		;// ロータリカム４　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P114		;// ロータリカム５　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D114		;// ロータリカム５　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P114		;// ロータリカム５　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D114		;// ロータリカム５　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P115		;// ロータリカム６　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D115		;// ロータリカム６　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P115		;// ロータリカム６　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D115		;// ロータリカム６　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P116		;// ロータリカム７　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D116		;// ロータリカム７　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P116		;// ロータリカム７　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D116		;// ロータリカム７　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P117		;// ロータリカム８　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D117		;// ロータリカム８　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P117		;// ロータリカム８　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D117		;// ロータリカム８　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P118		;// ロータリカム９　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D118		;// ロータリカム９　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P118		;// ロータリカム９　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D118		;// ロータリカム９　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P119		;// ロータリカム１０　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D119		;// ロータリカム１０　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P119		;// ロータリカム１０　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D119		;// ロータリカム１０　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P11A		;// ロータリカム１１　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D11A		;// ロータリカム１１　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P11A		;// ロータリカム１１　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D11A		;// ロータリカム１１　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P11B		;// ロータリカム１２　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D11B		;// ロータリカム１２　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P11B		;// ロータリカム１２　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D11B		;// ロータリカム１２　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P11C		;// ロータリカム１３　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D11C		;// ロータリカム１３　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P11C		;// ロータリカム１３　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D11C		;// ロータリカム１３　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P11D		;// ロータリカム１４　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D11D		;// ロータリカム１４　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P11D		;// ロータリカム１４　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D11D		;// ロータリカム１４　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P11E		;// ロータリカム１５　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D11E		;// ロータリカム１５　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P11E		;// ロータリカム１５　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D11E		;// ロータリカム１５　ＯＦＦ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_P11F		;// ロータリカム１６　ＯＮ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMON_D11F		;// ロータリカム１６　ＯＮ角度　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_P11F		;// ロータリカム１６　ＯＦＦ工程　タイマ仕様　2016/11/14
	extern	U2b	SVP_RCAMOF_D11F		;// ロータリカム１６　ＯＦＦ角度　タイマ仕様　2016/11/14
...
//;	===-2016-03-20 ﾌｨｰﾀﾞ=======
	extern	U4b	PVP_LFEED_POS		;//.SRES	4		;ﾌｨｰﾀﾞ現在位置
